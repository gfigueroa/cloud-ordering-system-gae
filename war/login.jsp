	...
	if (sessionUser != null) {
    	...
    	switch(sessionUser.getUserType()) {
        	case ADMINISTRATOR:
                ...
                break;
            case CUSTOMER:
                response.sendRedirect("/customer/customerListRestaurant.jsp");
                break;
            case RESTAURANT:
                response.sendRedirect("/restaurant/listOrder.jsp");
                break;
            default:
...
<div class="login-box">
	<div class="login-left">
	  	<form name="login-form" action="/attemptlogin" 
		    ...
		    <div class="login-box-user">
		    	<label><%= printer.print("Username") %></label><br/>
	...
	<div class="login-right">
		<div class="login-box-title">
		    <span><%= printer.print("Create") %></span> <br/><%= printer.print("a new account") %>.
		</div>
