...
%>
  <tr>
    ...
    <td width="10%"><img src="../images/edit1.jpg" width="23" height="23" /><a href="/admin/editRegion.jsp?k=<%= region.getKey() %>"><%= printer.print("Edit") %></a></td>
    <td width="10%"><img src="../images/delete.jpg" width="23" height="23" /><a href="javascript:void(0);" onclick="confirmDelete('/manageObject?action=delete&type=R&k=<%= region.getKey() %>', '<%= printer.print("Are you sure you want to delete this Region")%>');"><%= printer.print("Delete") %></a></td>
  </tr>
<%  
  }
%>
