...
public class User implements Serializable {
    ...
    public static enum Type {
    	ADMINISTRATOR, CUSTOMER, RESTAURANT
    };
    private Type type;
    ...
    public void setUserEmail(Email userEmail) throws UnauthorizedUserOperationException,
    	...
    	if (this.type == Type.ADMINISTRATOR || this.type == Type.RESTAURANT) {
    		this.userEmail = userEmail;
    	}
    	else {
    		throw new UnauthorizedUserOperationException(this, 
    				"Setting a user's email can only be performed by the Restaurant or " +
    				"Administrator types.");
    	}
    }
    ...
    public boolean validateUser(Email userEmail, String userPassword) {
    	if (userEmail.getEmail().equalsIgnoreCase(this.userEmail.getEmail()) && userPassword.equals(this.userPassword)) {
    		return true;
    	}
    	else {
    		return false;
