...
public class SessionVariablesServlet extends HttpServlet {
    ...
    private static final Logger log = 
        Logger.getLogger(SessionVariablesServlet.class.getName());
    
    // JSP file locations
    private static final String shoppingCartJSP = "/customer/customerShoppingCart.jsp";
    private static final String shoppingListJSP = "/customer/customerShoppingList.jsp";
    private static final String customerListMenuItemJSP = "/customer/customerListMenuItem.jsp";
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) 
	    ...
	    if (variableString.equals("cart")) {
            ...
            // View the cart
            	...
            	for (MenuItemContainer container : cartMenuItems) {
            		Key menuItemKey = container.menuItem.getKey();
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) 
        ...
        if (variableString.equals("cart")) {
            ...
            // Check-out
        		...
        		//TODO: Add orderComments when system is commercial
