...
%>
  <tr>
    ...
    <td width="10%"><img src="../images/edit1.jpg" width="23" height="23" /><a href="/admin/editAdmin.jsp?k=<%= KeyFactory.keyToString(admin.getKey()) %>"><%= printer.print("Edit Profile") %></a></td>
    <td width="10%"><img src="../images/delete.jpg" width="23" height="23" /><a href="javascript:void(0);"
                       onclick="confirmDelete('/manageUser?action=delete&u_type=A&k=<%= KeyFactory.keyToString(admin.getKey()) %>', '<%= printer.print("Are you sure you want to delete this Administrator")%>');"><%= printer.print("Delete") %></a>
    </td>
  </tr>
<%  
  }
