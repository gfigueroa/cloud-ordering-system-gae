...
%>
  <tr>
    ...
    <td width="10%"><img src="../images/edit1.jpg" width="23" height="23" /><a href="/admin/editCustomer.jsp?k=<%= KeyFactory.keyToString(customer.getKey()) %>"><%= printer.print("Edit Profile") %></a></td>
    <td width="10%"><img src="../images/delete.jpg" width="23" height="23" /><a href="javascript:void(0);"
                       onclick="confirmDelete('/manageUser?action=delete&u_type=C&k=<%= KeyFactory.keyToString(customer.getKey()) %>', '<%= printer.print("Are you sure you want to delete this Customer")%>');"><%= printer.print("Delete") %></a>
    </td>
  </tr>
<%  
  }
